...
4.  获取靶机的 MAC 地址. 笔者条件有限, 选用自己的平p电脑作为靶机. 笔者的平板电脑连接 Wi-Fi, 通过无线路由作为局域网的二级子网关接入上层局域网, 所以可以转而设定该二级网关为靶机, 达到相同效果.
...
本实验的所有内容 (含代码) 均已上传至 GitHub: https://github.com/srcres258/netsec-exp . 欢迎 Star!
